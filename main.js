...
let valorGift = 3000;
let valorMaceta1 = 6500;
let valorMaceta2 = 6000
...
while (opciones) {
        ...
        function unidades (){
            ...
            while (unidadesCantidades) {
                if (cantidades > 0) {
                  alert ("Sumamos a tu lista la cantidad de: " + cantidades)
                  resultado();
                  break;
